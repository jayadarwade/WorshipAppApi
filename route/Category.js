...
router.delete("/delete/:id",(request,response)=>{
    productCategoryModel.findByIdAndDelete({_id : request.params.id})
    .then(result=>{
        requests({
            url: "https://firebasestorage.googleapis.com/v0/b/worship-first.appspot.com/o/"+request.file.filename+"?alt=media&token=hello",
