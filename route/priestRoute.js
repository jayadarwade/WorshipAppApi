...
route.post('/priest_register',upload.single("image"), priestController.priestRegistration)

route.post('/priest_login', priestController.priestLogin)

route.post("/priest_updateprofile",upload.single("image"), priestController.priestUpdateprofile);
